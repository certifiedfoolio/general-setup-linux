...
case $RESULT in
    1) REPOLINK="https://github.com/vinceliuice/Fluent-icon-theme" && REPODIR="Fluent-icon-theme";
    2) REPOLINK="https://github.com/B00merang-Project/Windows-10/archive/refs/tags/3.2.1.zip" && MANINST="YES";;
    3) REPOLINK="https://github.com/yeyushengfan258/Win11-icon-theme" && REPODIR="Win11-icon-theme";;
    4) REPOLINK="https://github.com/vinceliuice/WhiteSur-icon-theme" && REPODIR="WhiteSur-icon-theme";;
    *) bash /setup.sh;;
esac
